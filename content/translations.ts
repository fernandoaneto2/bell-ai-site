...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    hero: {
      ...
      sub: "Bell.ai helps restaurants respond instantly, manage reservations automatically, and deliver a smoother customer experience — 24/7.",
      cta1: "Book a Demo",
  ...
  pt: {
    ...
    hero: {
      ...
      sub: "Bell.ai ajuda restaurantes a responder na hora, gerenciar reservas automaticamente e entregar uma experiência mais fluida — 24/7.",
      cta1: "Agendar Demo",
      cta2: "Ver em Ação",
  ...
  es: {
    ...
    hero: {
      ...
      sub: "Bell.ai ayuda a los restaurantes a responder al instante, gestionar reservas automáticamente y ofrecer una experiencia más fluida — 24/7.",
      cta1: "Reservar Demo",
  ...
  fr: {
    ...
    hero: {
      ...
      sub: "Bell.ai aide les restaurants à répondre instantanément, gérer les réservations automatiquement et offrir une expérience client plus fluide — 24h/24.",
  ...
  de: {
    ...
    hero: {
      ...
      sub: "Bell.ai hilft Restaurants, sofort zu antworten, Reservierungen automatisch zu verwalten und ein reibungsloseres Kundenerlebnis zu bieten — rund um die Uhr.",
      cta1: "Demo buchen",
  ...
  it: {
    ...
    hero: {
      ...
      sub: "Bell.ai aiuta i ristoranti a rispondere istantaneamente, gestire le prenotazioni in automatico e offrire un'esperienza cliente più fluida — 24/7.",
