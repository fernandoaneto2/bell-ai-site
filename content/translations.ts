...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    hero: {
      ...
      h1Line1: "Your guests deserve",
      h1Line2: "instant answers.",
      h1Line3: "Your staff deserves",
      h1Line4: "their time back.",
  ...
  pt: {
    ...
    hero: {
      ...
      h1Line1: "Seus hóspedes merecem",
      h1Line2: "respostas imediatas.",
      h1Line3: "Sua equipe merece",
      h1Line4: "tempo de volta.",
  ...
  es: {
    ...
    hero: {
      ...
      h1Line1: "Tus huéspedes merecen",
      h1Line2: "respuestas inmediatas.",
      h1Line3: "Tu equipo merece",
      h1Line4: "recuperar su tiempo.",
  ...
  fr: {
    ...
    hero: {
      ...
      h1Line1: "Vos clients méritent",
      h1Line2: "des réponses instantanées.",
      h1Line3: "Votre équipe mérite",
      h1Line4: "de récupérer son temps.",
  ...
  de: {
    ...
    hero: {
      ...
      h1Line1: "Ihre Gäste verdienen",
      h1Line2: "sofortige Antworten.",
      h1Line3: "Ihr Personal verdient",
      h1Line4: "seine Zeit zurück.",
  ...
  it: {
    ...
    hero: {
      ...
      h1Line1: "I tuoi ospiti meritano",
      h1Line2: "risposte immediate.",
      h1Line3: "Il tuo staff merita",
      h1Line4: "il suo tempo indietro.",
